...
// NewGetCouponIDParams creates a new GetCouponIDParams object
// no default values defined in spec.
func NewGetCouponIDParams() GetCouponIDParams {

	return GetCouponIDParams{}
}

// GetCouponIDParams contains all the bound params for the get coupon ID operation
...
func (o *GetCouponIDParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
