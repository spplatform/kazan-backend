...
// NewDeleteOrderIDParams creates a new DeleteOrderIDParams object
// no default values defined in spec.
func NewDeleteOrderIDParams() DeleteOrderIDParams {

	return DeleteOrderIDParams{}
}

// DeleteOrderIDParams contains all the bound params for the delete order ID operation
...
func (o *DeleteOrderIDParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
