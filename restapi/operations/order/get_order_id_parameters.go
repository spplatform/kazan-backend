...
// GetOrderIDParams contains all the bound params for the get order ID operation
...
func (o *GetOrderIDParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
